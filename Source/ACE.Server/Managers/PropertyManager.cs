    ...
    public static class DefaultPropertyManager
    {
        ...
        public static readonly ReadOnlyDictionary<string, Property<long>> DefaultLongProperties =
            DictOf(
                ...
                ("burden_capacity_floor", new Property<long>(5000, "(Shadowgain 009) Minimum carry capacity regardless of Strength, when burden_capacity_floor_enabled is on. 5000 is roughly the capacity of Strength 33 - enough that a weak caster is not stranded, far below a warrior. A starting point, not a tuned balance target")),
        ...
        public static readonly ReadOnlyDictionary<string, Property<double>> DefaultDoubleProperties =
            DictOf(
                ...
                ("skill_overcap_growth", new Property<double>(1.05, "(Shadowgain 005) Cost escalation per rank beyond the XP table top: each further rank costs this multiple of the previous one. 1.0 continues linearly at the table's final step; higher values keep the 'slow to master' curve going instead of flattening once the table runs out")),
