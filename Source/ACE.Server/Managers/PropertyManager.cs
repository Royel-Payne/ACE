    ...
    public static class DefaultPropertyManager
    {
        ...
        public static readonly ReadOnlyDictionary<string, Property<double>> DefaultDoubleProperties =
            DictOf(
                ...
                ("leadership_gain_xp_divisor", new Property<double>(10.0, "(Shadowgain 007) Divides XP earned while fellowed with your own vassals to produce a Leadership difficulty, then multiplied by how many vassals are present. XP runs in the thousands while other difficulties are skill values in the tens, hence the divide. Set generously - Chris: Leadership and Loyalty have little gameplay impact, so they should not be a grind")),
                ("loyalty_gain_xp_divisor", new Property<double>(10.0, "(Shadowgain 007) Divides XP passed up to your patron to produce a Loyalty difficulty. Same scale reason and same relaxed intent as leadership_gain_xp_divisor")),
