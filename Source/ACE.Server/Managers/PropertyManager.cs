    ...
    public static class DefaultPropertyManager
    {
        ...
        public static readonly ReadOnlyDictionary<string, Property<bool>> DefaultBooleanProperties =
            DictOf(
                ...
                ("disable_specialization", new Property<bool>(true, "(Shadowgain 013) If enabled, no skill can be Specialized: existing spec is demoted to Trained on enter-world and SpecializeSkill is rejected at the single chokepoint that creation, the skill temple and Asheron's Castle all funnel through. Greylock's vision is one flat rule - everything Trained, everything earned by use. Demotion preserves earned ranks and tops up XP to the trained-table cost, since a spec rank is cheaper than a trained one. Turning this off leaves already-demoted skills demoted; it is not a rollback")),
