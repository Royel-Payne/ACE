    ...
    public static class DefaultPropertyManager
    {
        ...
        public static readonly ReadOnlyDictionary<string, Property<double>> DefaultDoubleProperties =
            DictOf(
                ...
                ("dualwield_specialty_attribute_weight", new Property<double>(0.30, "(Shadowgain 187b) Scale on the DualWield specialty attribute award. CALIBRATED, not guessed: with off-hand share f, the Coordination deficit created by dualwield_offhand_credits_weapon_skill is f*(0.9-0.225) per swing, while this pays 0.9*weight on every dual-wield swing, so weight = 0.75*f. Measured on TEST 2026-08-21 with the dial off (48 main-hand vs 33 off-hand swings, f=0.407) this gives 0.305; cross-checked against raw counts as 0.306. Hence 0.30, which restores Coordination to its pre-fix level without exceeding it. A previous 0.25 came from a guessed 35 percent share and is superseded. Raise toward 0.34 if off-hand share runs higher on LIVE; 0 disables the award while leaving the enable dial on")),
