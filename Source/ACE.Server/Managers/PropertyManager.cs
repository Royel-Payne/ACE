    ...
    public static class DefaultPropertyManager
    {
        ...
        public static readonly ReadOnlyDictionary<string, Property<bool>> DefaultBooleanProperties =
            DictOf(
                ...
                ("all_skills_trained", new Property<bool>(true, "(Shadowgain) If enabled, every valid skill is granted at least Trained - at character creation and on login - free of skill-credit cost. Required for skills to be able to rise through use, since Proficiency only fires at Trained or above")),
